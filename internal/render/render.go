...
// Iterate returns a slice of ints([]int), starting at 1, going to count
...
// NewRenderer sets the config for the config package
...
func CreateTemplateCache() (map[string]*template.Template, error) {
	...
	pages, err := filepath.Glob(fmt.Sprintf("%s/*.page.tmpl", pathToTemplates)) //look through all templates which ends .page.(tmpl)html
	if err != nil {
		return myCache, err
	}
